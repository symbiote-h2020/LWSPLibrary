...
lib.getHashOfIdentity.restype = ctypes.c_char_p
...
if __name__ == "__main__":
    ...
    resource_1 = str('{\
		  ...
		  "resource": {\
			"@c": ".StationarySensor",\
			"id": "",\
			"name": "SENS-SDEV_6B:76",\
			"description": null,\
			"interworkingServiceURL": "http://example.url",\
			"locatedAt": null,\
			"services": null,\
			"observesProperty": [\
			  "temperature",\
